...
public class Applyjobdocx extends Basetest{
	...
	public void postjobmanullyscript() throws Exception
	{
		...
		ScreenRecorderUtil.startRecord("Apply Job");
	      ...
	      Workbook book=WorkbookFactory.create(f);
			  ...
			  ExtentTest test =  extent.createTest("Apply Job Docx", "Verify Apply Job Docx");
		      ...
		      try {
		       ...
		       //  driver.findElement(By.xpath("//p[text()='Copy URL']")).click();
		         ...
		         StringSelection stringSelection = new StringSelection("C:\\Users\\system3\\eclipse-workspace\\AptaHR_Jenkins\\documents\\QA1.jpg");
		         ...
		         try {
					 ...
					 aj.setemail("dhruva@spacehotline.com");
		         ...
		         StringSelection stringSelection1 = new StringSelection("C:\\Users\\system3\\eclipse-workspace\\AptaHR_Jenkins\\documents\\Quality Assurance Skills Resume.docx");
			     ...
			     test.info("Resume uploaded in Docx format");
